...
const seedTexts = [
  ...
  "Новая идея для следующей лабораторной: подключить внешний сервис и загружать посты асинхронно.",
  "Напоминаю, что в этой работе нужно показать минимум три типа событий. У нас уже есть клик, ввод и отправка формы.",
  "Проверила локальное хранилище: лайки и комментарии сохраняются даже после перезагрузки страницы.",
...
const seedComments = [
  ...
  "Сохранение в локальном хранилище особенно пригодилось.",
